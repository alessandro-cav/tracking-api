...
INSERT INTO tb_user (email, nome, role, senha,status_usuario,cnpj_banco)
SELECT 'teste@gmail.com', 'teste', 'ADMIN', '$2a$12$W4ga0wBDtSMXGY0y41/PAuY8o0E.SGucCpddVRY6gvZhPxA16bpGi', 'ATIVO','57050558000107'
WHERE NOT EXISTS (SELECT email FROM tb_user WHERE id = 2);
